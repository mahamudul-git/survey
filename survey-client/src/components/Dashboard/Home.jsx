  ...
  return (
    <main className="flex-1 w-full max-w-full bg-[#0E1525]/50 backdrop-blur-sm border border-[#9767E4]/10 rounded-2xl">
      ...
      <div className="px-5 py-6 md:px-6 md:py-8">
        <div className="mb-6">
          <h2 className="text-xl md:text-2xl font-bold mb-4 bg-gradient-to-r from-[#9767E4] via-[#C084FC] to-[#26B2F2] bg-clip-text text-transparent">Swap Survey</h2>
          <div
            ref={tabRef}
          ...
          >
            {TAB_LIST.map((tab) => (
              ...
              >
                {tab.name}
                {tab.badge !== undefined && (
                  <span className="px-2 py-1 text-xs font-semibold bg-gradient-to-r from-[#9767E4] to-[#26B2F2] text-white rounded-full shadow-sm">
                    {tab.badge}
                  </span>
                )}
              </button>
