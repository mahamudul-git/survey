...
const FeaturedOffers = () => {
  ...
  const maxIdx = allOffers.length - cardsPerView;
  ...
  return (
    <div className="px-5 pt-6 md:px-2 md:px-[20px] md:pt-8 w-full max-w-full bg-[#f7f7f7] rounded-3xl">
      <div className="flex items-center justify-between gap-4 mb-4">
        <span className="text-base md:text-xl font-bold text-gray-800">Featured Offers</span>
      ...
      >
        <div
          ...
          style={{ width: `${allOffers.length * cardWidth}px`, transition: 'transform 0.4s cubic-bezier(.4,1,.3,1)', transform: `translateX(${-carouselIdx * cardWidth}px)` }}
        >
