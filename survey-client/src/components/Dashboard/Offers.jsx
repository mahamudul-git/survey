...
const OffersHeader = ({ selectedDevice, setSelectedDevice }) => {
	...
	return (
		<div ref={dropdownRef}>
			...
			<div className="flex items-center justify-between gap-4 mb-4">
				<span className="text-base md:text-xl font-bold text-gray-800">App Testing Offers</span>
...
const Offers = () => {
	...
	const filteredOffers = selectedDevice === 'All' ? offers : offers.filter(o => o.device === selectedDevice);

	return (
		<div className="flex-1 px-5 py-6 md:px-2 md:px-[20px] md:py-8 bg-[#f7f7f7] rounded-3xl">
			<OffersHeader selectedDevice={selectedDevice} setSelectedDevice={setSelectedDevice} />
					...
					>
						<div className="flex w-full gap-2">
							...
							<div className="flex-1 flex flex-col justify-center">
                                ...
                                {offer.title.length > 20 ? offer.title.slice(0, 20) + '...' : offer.title}
								</div>
								<div className="flex items-center gap-1 mb-0.5">
									<span className="line-through text-[10px] text-gray-400"><img src="/token.svg" alt="token" className="w-4 h-4 inline-block" />{offer.oldReward}</span>
									<span className="text-base font-bold text-[#347433]"><img src="/token.svg" alt="token" className="w-4 h-4 inline-block" />{offer.reward}</span>
								</div>
